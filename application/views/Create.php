                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="h5 modal-title text-center">
                                        <h4 class="mt-0">
                                            <div><n i18n="Create">[0]</n> <n i18n="Account">[1]</n></div>
                                        </h4>
                                    </div>
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <span><n i18n="Create">[0]</n><n i18n="Account">[1]</n></span><br>
                                                    <textarea class="form-control alert alert-info show text_BandFrame" rows="2" id="CreateAccount_show" readonly>ak_****</textarea>
                                                <span i18n="MnemonicTips">[0]</span><br><br>
                                    ...
                                    <h6 class="mb-0"><a href="/Login" class="text-primary"><n i18n="Mnemonic">[0]</n><n i18n="login">[1]</n></a></h6>
                                </div>
                                <div class="modal-footer clearfix">
                                    <div class="float-right">
                                        <button class="btn btn-primary btn-lg" onclick="return Create_MMWords_check();" i18n="Create">生成</button>
                                    </div>
                                </div>
                            </div>
                        </div>
