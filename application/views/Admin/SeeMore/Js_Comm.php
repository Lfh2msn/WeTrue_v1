<div class="card-footer d-flex flex-wrap justify-content-between px-0 pt-0 pb-0">
    <div class="px-4 pt-0">
        <span class="text-muted d-inline-flex align-items-center align-middle">
            <i class="CommentLove metismenu-icon pe-7s-like pe-2x pe-va" id="${item[i].hash}"><span style="font-size:15px">${item[i].love}</span></i>
        </span>
        <span class="text-muted d-inline-flex align-items-center align-middle ml-5">
            ...
            <span class="align-middle">${item[i].commsum}</span>
        </span></a>
    </div>
    <div class="px-4 pt-1">
        <div class="dropdown d-inline-block">
            ...
            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a href="https://www.aeknow.org/miner/viewaccount/${item[i].hash}" target="_blank" class="nav-link">
                            <i class="nav-link-icon pe-7s-network"></i><span>AEKnow</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="https://mainnet.aeternal.io/transactions/${item[i].hash}" target="_blank" class="nav-link">
