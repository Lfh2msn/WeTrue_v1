                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="mm-show">
                                    ...
                                    <li>
                                        <a href="/LatestReply">
                                            <span i18n="LatestReply">最新评论</span>
                                        </a> 
                                    </li>
                                    <li>
                                        <a href="/LatestPictures">
                                            <span i18n="LatestImages">最新图片</span>
                                        </a> 
                                    </li>
                                    <li>
                                        <a href="/HotPosts">
                            ...
                            <li>
                                ...
                                <ul >
                                    <li>
                                        <a href="/faq/help0">
                                        <i class="metismenu-icon"></i>
                                        <n i18n="C_Problem">常见问题</n>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/faq/help1">
                                        <i class="metismenu-icon"></i>
                                        <n i18n="Usehelp">使用帮助</n>-1
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/faq/help2">
                                        <i class="metismenu-icon"></i>
                                        <n i18n="Usehelp">使用帮助</n>-2
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/faq/help3">
                                        <i class="metismenu-icon"></i>
                                        <n i18n="Activity">等级及活跃度</n>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/faq/cost">
